...
public class DBHelper extends SQLiteOpenHelper {
    ...
    // Contacts table name
    private static final String TABLE_ITEM_BARCODE = "ITEM_BARCODE";
    ...
    // Adding new item
    public void addItem(ItemBarcode itemBarcode) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(KEY_ITEM_CODE, itemBarcode.getCode()); // Item Code
        values.put(KEY_ITEM_NAME, itemBarcode.getName()); // Item Name
        // Inserting Row
    ...
    // Getting one item
    public ItemBarcode getItem(int id) {
    ...
    // Getting All Items
    public List<ItemBarcode> getAllItems() {
        List<ItemBarcode> itemList = new ArrayList<ItemBarcode>();
        // Select All Query
        ...
        if (cursor.moveToFirst()) {
            do {
                ItemBarcode item = new ItemBarcode();
    ...
    // Updating an item
    public int updateItem(ItemBarcode item) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
    ...
    // Deleting an item
    public void deleteItem(ItemBarcode item) {
        SQLiteDatabase db = this.getWritableDatabase();
